...
export const getServerSideProps = (async ({ locale }) => {
  let seoData: ISeoProps = {
    title: 'Lifestyle',
    description: 'Khám phá Phong cách sống và góc nhìn mới cùng Kỳ Anh Nguyễn',
  }
  return {
...
const ViewLifestyle = dynamic(() => import('@/views/Lifestyle'), {
  suspense: true,
  ssr: false,
})

const Lifestyle: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = (props) => {
  return (
    <Suspense fallback="...">
