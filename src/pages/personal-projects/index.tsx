...
export const getServerSideProps = (async ({ locale }) => {
  let seoData: ISeoProps = {
    ...
    description: 'Khám phá Những dự án cá nhân của Kỳ Anh Nguyễn',
  }
  return {
...
const ViewPersonalProjects = dynamic(() => import('@/views/PersonalProjects'), {
  suspense: true,
  ssr: false,
})

const PersonalProjects: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = (props) => {
  return (
    <Suspense fallback="...">
...
PersonalProjects.getLayout = (page) => {
