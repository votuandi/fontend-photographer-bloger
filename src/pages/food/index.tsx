...
export const getServerSideProps = (async ({ locale }) => {
  let seoData: ISeoProps = {
    title: 'Foods',
    description: 'Khám phá Những món ăn ngon cùng Kỳ Anh Nguyễn',
  }
  return {
...
const ViewFoods = dynamic(() => import('@/views/Food'), {
  suspense: true,
  ssr: false,
})

const Foods: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = (props) => {
  return (
    <Suspense fallback="...">
